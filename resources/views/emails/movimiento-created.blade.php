...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #2c3e50; margin: 0; padding: 0; background-color: #f4f4f4;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        ...
        <div style="background-color: #ffffff; padding: 20px; text-align: center; border-bottom: 1px solid #f8f9fa;">
            ...
            <h1 style="color: #006D95; font-size: 24px; font-weight: 600; margin: 0; padding: 0;">Notificación de Movimiento</h1>
            <p style="color: #004A66; font-size: 16px; margin-top: 10px;">Se ha registrado un nuevo movimiento en el sistema</p>
        </div>
                ...
                <tr>
                    <td style="width: 50%; padding: 10px;">
                        <div style="margin-bottom: 15px;">
                            ...
                            <div style="font-size: 15px; color: #2c3e50; font-weight: 500;">{{ $movimiento->usuarioOrigen->nombre }}</div>
                        </div>
                    </td>
                    <td style="width: 50%; padding: 10px;">
                        <div style="margin-bottom: 15px;">
                            <div style="font-size: 12px; text-transform: uppercase; color: #95a5a6; margin-bottom: 5px;">Recibido por</div>
                            <div style="font-size: 15px; color: #2c3e50; font-weight: 500;">{{ $movimiento->usuarioDestino->nombre }}</div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; padding: 10px;">
                        <div style="margin-bottom: 15px;">
                            ...
                            <div style="font-size: 15px; color: #2c3e50; font-weight: 500;">{{ $movimiento->fecha_movimiento->format('d/m/Y H:i') }}</div>
                        </div>
                    </td>
                    <td style="width: 50%; padding: 10px;">
                        <div style="margin-bottom: 15px;">
                            <div style="font-size: 12px; text-transform: uppercase; color: #95a5a6; margin-bottom: 5px;">Registrado por</div>
                            <div style="font-size: 15px; color: #2c3e50; font-weight: 500;">{{ $movimiento->realizadoPor->name }}</div>
                        </div>
                    </td>
                </tr>
            </table>
